...
export class CounterApp extends DDDSuper(I18NMixin(LitElement)) {
  ...
  increment() {
    ...
    if (this.counter == this.max) {
      // check if the counter is equal to the maximum value
  ...
  decrement() {
    ...
    if (this.counter == this.min) {
      // check if the counter is equal to the minimum value
  ...
  render() {
    return html` <div class="wrapper">
      <confetti-container>
        ...
        <div class="min-max">
          ${this.min !== undefined ? html`<p>Minimum: ${this.min}</p>` : ""}
          <!-- if the min is not defined then display the minimum value otherwise show an empty string -->
          ${this.max !== undefined ? html`<p>Maximum: ${this.max}</p>` : ""}
          <!-- if the max is not defined then display the minimum value otherwise show an empty string -->
        </div>
      </confetti-container>
    </div>`;
  }
